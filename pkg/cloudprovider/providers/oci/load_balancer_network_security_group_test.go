...
func TestGenerateLbNsgEgressRules(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			expected: []core.SecurityRule{
				makeNsgSecurityRule(core.SecurityRuleDirectionEgress, "nsgId1", "lbocid", 10257, ProtocolTCP, core.SecurityRuleSourceTypeNetworkSecurityGroup),
				makeNsgSecurityRule(core.SecurityRuleDirectionEgress, "nsgId2", "lbocid", 10257, ProtocolTCP, core.SecurityRuleSourceTypeNetworkSecurityGroup),
				makeNsgSecurityRule(core.SecurityRuleDirectionEgress, "nsgId3", "lbocid", 10257, ProtocolTCP, core.SecurityRuleSourceTypeNetworkSecurityGroup),
				makeNsgSecurityRule(core.SecurityRuleDirectionEgress, "nsgId1", "lbocid", 30001, ProtocolTCP, core.SecurityRuleSourceTypeNetworkSecurityGroup),
				makeNsgSecurityRule(core.SecurityRuleDirectionEgress, "nsgId2", "lbocid", 30001, ProtocolTCP, core.SecurityRuleSourceTypeNetworkSecurityGroup),
				makeNsgSecurityRule(core.SecurityRuleDirectionEgress, "nsgId3", "lbocid", 30001, ProtocolTCP, core.SecurityRuleSourceTypeNetworkSecurityGroup),
			},
		},
		{
...
func TestGenerateBackendNsgIngressRules(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			lbId:             "lbocid",
			expected: []core.SecurityRule{
				makeNsgSecurityRule(core.SecurityRuleDirectionIngress, "frontendnsgocid", "lbocid", 80, ProtocolTCP, core.SecurityRuleSourceTypeNetworkSecurityGroup),
				makeNsgSecurityRule(core.SecurityRuleDirectionIngress, "frontendnsgocid", "lbocid", k8sports.ProxyHealthzPort, ProtocolTCP, core.SecurityRuleSourceTypeNetworkSecurityGroup),
			},
		},
		{
			name:          "ingress backend rules",
			...
			expected: []core.SecurityRule{
				makeNsgSecurityRule(core.SecurityRuleDirectionIngress, "frontendnsgocid", "lbocid", 80, ProtocolTCP, core.SecurityRuleSourceTypeNetworkSecurityGroup),
				makeNsgSecurityRule(core.SecurityRuleDirectionIngress, "frontendnsgocid", "lbocid", 443, ProtocolTCP, core.SecurityRuleSourceTypeNetworkSecurityGroup),
				makeNsgSecurityRule(core.SecurityRuleDirectionIngress, "frontendnsgocid", "lbocid", k8sports.ProxyHealthzPort, ProtocolTCP, core.SecurityRuleSourceTypeNetworkSecurityGroup),
			},
		},
		{
			...
			lbId:             "lbocid",
			expected: []core.SecurityRule{
				makeNsgSecurityRule(core.SecurityRuleDirectionIngress, "0.0.0.0/0", "lbocid", 3000, ProtocolTCP, core.SecurityRuleSourceTypeCidrBlock),
				makeNsgSecurityRule(core.SecurityRuleDirectionIngress, "1.1.1.1/1", "lbocid", 3000, ProtocolTCP, core.SecurityRuleSourceTypeCidrBlock),
				makeNsgSecurityRule(core.SecurityRuleDirectionIngress, "frontendnsgId", "lbocid", 3000, ProtocolTCP, core.SecurityRuleSourceTypeNetworkSecurityGroup),
				makeNsgSecurityRule(core.SecurityRuleDirectionIngress, "frontendnsgId", "lbocid", k8sports.ProxyHealthzPort, ProtocolTCP, core.SecurityRuleSourceTypeNetworkSecurityGroup),
			},
		},
	}
	...
	testCases := []struct {
	...
	}{
		{
			...
			existingSecurityRules: []core.SecurityRule{
				makeNsgSecurityRule(core.SecurityRuleDirectionIngress, "0.0.0.0/0", "lbocid", 80, ProtocolTCP, core.SecurityRuleSourceTypeCidrBlock),
				makeNsgSecurityRule(core.SecurityRuleDirectionIngress, "1.1.1.1/1", "lbocid", 80, ProtocolTCP, core.SecurityRuleSourceTypeCidrBlock),
				makeNsgSecurityRule(core.SecurityRuleDirectionIngress, "2.2.2.2/2", "lbocid", 80, ProtocolTCP, core.SecurityRuleSourceTypeCidrBlock),
			},
		...
		},
		{
			...
			existingSecurityRules: []core.SecurityRule{
				makeNsgSecurityRule(core.SecurityRuleDirectionIngress, "0.0.0.0/0", "lbocid", 81, ProtocolTCP, core.SecurityRuleSourceTypeCidrBlock),
				makeNsgSecurityRule(core.SecurityRuleDirectionIngress, "0.0.0.0/0", "lbocid", 8080, ProtocolTCP, core.SecurityRuleSourceTypeCidrBlock),
				makeNsgSecurityRule(core.SecurityRuleDirectionIngress, "1.1.1.1/1", "lbocid", 80, ProtocolTCP, core.SecurityRuleSourceTypeCidrBlock),
				makeNsgSecurityRule(core.SecurityRuleDirectionIngress, "1.1.1.1/1", "lbocid", 8080, ProtocolTCP, core.SecurityRuleSourceTypeCidrBlock),
				makeNsgSecurityRule(core.SecurityRuleDirectionIngress, "0.0.0.0/0", "lbocid", 81, ProtocolTCP, core.SecurityRuleSourceTypeCidrBlock),
				makeNsgSecurityRule(core.SecurityRuleDirectionIngress, "0.0.0.0/0", "lbocid", 8080, ProtocolTCP, core.SecurityRuleSourceTypeCidrBlock),
				makeNsgSecurityRule(core.SecurityRuleDirectionIngress, "1.1.1.1/1", "lbocid", 80, ProtocolTCP, core.SecurityRuleSourceTypeCidrBlock),
				makeNsgSecurityRule(core.SecurityRuleDirectionIngress, "1.1.1.1/1", "lbocid", 8080, ProtocolTCP, core.SecurityRuleSourceTypeCidrBlock),
	...
	testCases := []struct {
	...
	}{
		{
			...
			rules: []core.SecurityRule{
				...
				makeNsgSecurityRule(core.SecurityRuleDirectionIngress, "1.1.1.1/1", "lbocid", 80, ProtocolTCP, core.SecurityRuleSourceTypeCidrBlock),
				makeNsgSecurityRule(core.SecurityRuleDirectionIngress, "2.2.2.2/2", "lbocid", 80, ProtocolTCP, core.SecurityRuleSourceTypeCidrBlock),
				makeNsgSecurityRule(core.SecurityRuleDirectionIngress, "2.2.2.2/2", "randomUID", 80, ProtocolTCP, core.SecurityRuleSourceTypeCidrBlock),
			},
			expectedRules: []core.SecurityRule{
				makeNsgSecurityRule(core.SecurityRuleDirectionIngress, "0.0.0.0/0", "lbocid", 80, ProtocolTCP, core.SecurityRuleSourceTypeCidrBlock),
				makeNsgSecurityRule(core.SecurityRuleDirectionIngress, "1.1.1.1/1", "lbocid", 80, ProtocolTCP, core.SecurityRuleSourceTypeCidrBlock),
